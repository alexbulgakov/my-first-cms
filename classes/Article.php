...
class Article {
	...
	/**
	 * @var int активность статьи (1 - активна, 0 - неактивна)
	 */
	public $active = null;
	...
	public static function getList($numRows = 1000000,
		...
		$activeClause = $onlyActive ? "AND active = 1" : "";
		$categoryClause = $categoryId ? "WHERE categoryId = :categoryId $activeClause" : ($onlyActive ? "WHERE active = 1" : "");
		$sql = "SELECT *, UNIX_TIMESTAMP(publicationDate) 
                AS publicationDate
